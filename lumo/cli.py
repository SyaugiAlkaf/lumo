...
from lumo.chain.adapter import build_chain_adapter
...
from lumo.monitor.events import EventBus
from lumo.monitor.webhooks import build_webhooks
from lumo.oracle.adapter import build_oracle
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="lumo")
