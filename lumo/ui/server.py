...
from lumo import testtool
from lumo.chain import ChainError
from lumo.config import PROFILES, Config
...
def serve(db_path: str, port: int = 8787):
    ...
    print(f"lumo ui on http://127.0.0.1:{port} (db={db_path})")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--db", default="lumo.db")
