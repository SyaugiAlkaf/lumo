...
PROM_COUNTERS = {
    "proposed": "amanah_intents_proposed_total",
    "refused": "amanah_intents_refused_total",
    "injection_blocked": "amanah_injection_blocked_total",
    "held": "amanah_intents_held_total",
    "released": "amanah_intents_released_total",
    "reverted": "amanah_intents_reverted_total",
    "refunded": "amanah_intents_refunded_total",
}
PROM_GAUGES = {
    "escrowed_value": "amanah_escrowed_value_stroops",
    "intents_open": "amanah_intents_open",
}
